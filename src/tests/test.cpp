...
public:
    ...
    dataBoat(other), time(other.time) {
    }
    ...
    virtual bool copy(dataBoat** to){
        ...
        if(!dataBoat::copy(to)){return false;}
        action* a = (action*) *to;
        a->time=this->time;
        return true;
    }
    ...
    virtual bool toVars(std::vector<std::pair<std::string, std::string> >* vars){
        ...
        string tmp;
        p.first = "time";
        if(toolbox::toString(this->time,&tmp)!=toolbox::toolboxError_noError){return false;}
        p.second = tmp;
        vars->push_back(p);
        
        //Parent serilize
        if(!dataBoat::toVars(vars)){return false;}
        
        return true;
    }

    virtual bool fromVars(std::vector<std::pair<std::string, std::string> >* vars, int pos){
        if(vars==NULL || vars->size()<pos+1){return false;}
        int tmp;
        
        //time
        if(toolbox::toInt(&((*vars)[pos++].second),&tmp)!=true){return false;}
        this->time = tmp;
        
        //Parent unserilize
        if(!dataBoat::fromVars(vars,pos)){return false;}
        return true;
    }    
};
...
namespace actions{
    ...
    public:
        ...
        virtual bool copy(dataBoat** to){
            ...
            if(!action::copy(to)){return false;}
            driveX* o = (driveX*) *to;
            o->x = this->x;
            return true;
        }
        ...
        virtual bool toVars(std::vector<std::pair<std::string, std::string> >* vars){
            ...
            string tmp;
            p.first = "dX";
            if(toolbox::toString(this->x*100,&tmp)!=toolbox::toolboxError_noError){return false;}
            p.second = tmp;
            vars->push_back(p);

            //Parent serilize
            if(!action::toVars(vars)){return false;}
        ...
        virtual bool fromVars(std::vector<std::pair<std::string, std::string> >* vars, int pos){
            ...
            //Parent unserilize
            if(!action::fromVars(vars,pos)){return false;}
            return true;
        }   
    ...
    public:
        ...
        virtual bool toVars(std::vector<std::pair<std::string, std::string> >* vars){
            ...
            string tmp;
            p.first = "dY";
            if(toolbox::toString(this->y*100,&tmp)!=toolbox::toolboxError_noError){return false;}
            p.second = tmp;
            vars->push_back(p);
    ...
    public:
        ...
        virtual bool toVars(std::vector<std::pair<std::string, std::string> >* vars){
            ...
            string tmp;
            p.first = "dZ";
            if(toolbox::toString(this->z*100,&tmp)!=toolbox::toolboxError_noError){return false;}
            p.second = tmp;
            vars->push_back(p);
    ...
    public:
        enum gears{slow=0,normal=1,full=2};
        gears gear;
        ...
        virtual bool toVars(std::vector<std::pair<std::string, std::string> >* vars){
            ...
            string tmp;
            p.first = "dGear";
            if(toolbox::toString(this->gear,&tmp)!=toolbox::toolboxError_noError){return false;}
            p.second = tmp;
            vars->push_back(p);
        ...
        virtual bool fromVars(std::vector<std::pair<std::string, std::string> >* vars, int pos){ 
            ...
            //time
            if(toolbox::toInt(&((*vars)[pos++].second),&tmp)!=true){return false;}
            if(tmp!=slow && tmp!=normal && tmp!=full){return false;}
            switch(tmp){
                case(slow):
                    this->gear=slow;
                    break;
    ...
    public:
        ...
        virtual bool toVars(std::vector<std::pair<std::string, std::string> >* vars){
            ...
            string tmp;
            p.first = "gy";
            if(toolbox::toString(this->value,&tmp)!=toolbox::toolboxError_noError){return false;}
            p.second = tmp;
            vars->push_back(p);
    ...
    public:
        enum gears{off=0, slow=1,normal=2,full=3};
        gears gear;
        ...
        virtual bool fromVars(std::vector<std::pair<std::string, std::string> >* vars, int pos){
            ...
            //time
            if(toolbox::toInt(&((*vars)[pos++].second),&tmp)!=true){return false;}
            if(tmp!=off && tmp!=slow && tmp!=normal && tmp!=full){return false;}
            switch(tmp){
                case(off):
                    this->gear=off;
                    break;
